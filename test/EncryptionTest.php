...
class EncryptionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFailure()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\Lyhiving\EasyRSA\Exception\InvalidChecksumException', $ex);
        }
        $dissect[3] = substr(
        ...
        try {
            ...
            $this->assertInstanceOf('\Lyhiving\EasyRSA\Exception\InvalidCiphertextException', $ex);
        }
